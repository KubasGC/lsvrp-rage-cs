...
declare interface MpGameCutscene {
    setCutscenePedPropVariation(cutsceneEntName: string,
        p1: number,
        p2: number,
        p3: number,
        modelHash: string | number): void;
    ...
    setCutscenePetComponentVariation(cutsceneEntName: string,
        p1: number,
        p2: number,
        p3: number,
        modelHash: string | number): void;
    ...
    registerEntityForCutscene(cutscenePed: MpPed | object,
