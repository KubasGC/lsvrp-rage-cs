...
declare interface MpGameEntity {
    removeModelSwap(x: number,
        y: number,
        z: number,
        radius: number,
        originModel: string | number,
    ...
    createModelHideExcludingScriptObjects(x: number,
        y: number,
        z: number,
        radius: number,
        model: string | number,
    ...
    createModelSwap(x: number,
        ...
        newModel: string | number,
        p6: boolean): void;
    playSynchronizedMapEntityAnim(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: object,
