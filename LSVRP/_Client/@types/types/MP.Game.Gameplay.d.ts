...
declare interface MpGameGameplay {
    displayOnscreenKeyboard(p0: number,
        windowTitle: string,
        p2: string,
        defaultText: string,
        ...
        maxInputLength: number): void; //TODO: Change windowTitle to mp.game.gameplay.windowTitles
    clearAreaOfVehicles(x: number,
        y: number,
        z: number,
        radius: number,
        p4: boolean,
    ...
    clearAngledAreaOfVehicles(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
    ...
    isBulletInAngledArea(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
    ...
    isProjectileTypeInArea(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
    ...
    setWeatherTypeTransition(sourceWeather: string | number,
        targetWeather: string | number,
        transitionTime: number): void;
    ...
    findSpawnPointInDirection(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
        z2: number,
        distance: number,
        spawnPoint: MpVector3): MpVector3;
    ...
    shootSingleBulletBetweenCoords(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
    ...
    clearAreaOfEverything(x: number,
        y: number,
        z: number,
        radius: number,
        p4: boolean,
    ...
    hasBulletImpactedInBox(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
    ...
    isPointObscuredByAMissionEntity(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: object):
        boolean;
    ...
    isProjectileTypeInAngledArea(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
    ...
    getDistanceBetweenCoords(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, useZ: boolean):
        number;
