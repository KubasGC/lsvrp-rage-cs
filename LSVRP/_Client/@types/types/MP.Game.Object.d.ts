...
declare interface MpGameObject {
    ...
    createPortablePickup2(pickupHash: string | number,
        x: number,
        y: number,
        z: number,
        placeOnGround: boolean,
        modelHash: string | number): MpPickup;
    getObjectOffsetFromCoords(xPos: number,
        yPos: number,
        zPos: number,
        heading: number,
        xOffset: number,
        yOffset: number,
        zOffset: number): MpVector3;
    getPickupCoords(p0: object): number;
    removeAllPickupsOfType(p0: object): void;
    isPointInAngledArea(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
        ...
        p10: boolean,
        p11: boolean): boolean;
    createPortablePickup(pickupHash: string | number,
        x: number,
        y: number,
        z: number,
        placeOnGround: boolean,
    ...
    addDoorToSystem(doorHash: string | number,
        modelHash: string | number,
        x: number,
        y: number,
        z: number,
        ...
        p6: number,
        p7: number): void;
    hasClosestObjectOfTypeBeenBroken(p0: number,
        p1: number,
        p2: number,
        p3: number,
        modelHash: string | number,
    ...
    createPickupRotate(pickupHash: string | number,
        posX: number,
        posY: number,
        posZ: number,
        rotX: number,
    ...
    createObjectNoOffset(modelHash: string | number,
        x: number,
        y: number,
        z: number,
        networkHandle: boolean,
        createHandle: boolean,
        dynamic: boolean): MpObject;
    doorControl(doorHash: string | number,
        x: number,
        y: number,
        z: number,
        locked: boolean,
    ...
    doesObjectOfTypeExistAtCoords(x: number, y: number, z: number, radius: number, hash: string | number, p5: boolean):
        boolean;
    ...
    getClosestObjectOfType(x: number,
        y: number,
        z: number,
        radius: number,
        modelHash: string | number,
        ...
        p6: boolean,
        p7: boolean): MpObject;
    getStateOfClosestDoorOfType(type: string | number,
        x: number,
        y: number,
        z: number,
        locked: boolean,
    ...
    setStateOfClosestDoorOfType(type: string | number,
        x: number,
        y: number,
        z: number,
        locked: boolean,
    ...
    createPickup(pickupHash: string | number,
        posX: number,
        posY: number,
        posZ: number,
        p4: number,
