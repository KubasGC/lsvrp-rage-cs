...
declare interface MpGamePathfind {
    setRoadsBackToOriginalInAngledArea(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
    ...
    updateNavmeshBlockingObject(p0: object,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
    ...
    getClosestRoad(x: number,
        ...
        p9: object,
        p10: object): object;
    setRoadsInAngledArea(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
    ...
    getNthClosestVehicleNodeId(x: number, y: number, z: number, nth: number, nodetype: number, p5: number, p6: number):
        number;
    getClosestVehicleNode(x: number,
        y: number,
        z: number,
        outPosition: MpVector3,
        nodeType: number,
        p5: number,
        p6: number): MpVector3;
    getClosestMajorVehicleNode(x: number,
        y: number,
        z: number,
        outPosition: MpVector3,
        unknown1: number,
        unknown2: number): MpVector3;
    ...
    getNthClosestVehicleNodeFavourDirection(x: number,
        y: number,
        z: number,
        desiredX: number,
        desiredY: number,
    ...
    getNthClosestVehicleNodeIdWithHeading(x: number,
        y: number,
        z: number,
        nthClosest: number,
        outPosition: MpVector3,
    ...
    getNthClosestVehicleNodeWithHeading(x: number,
        y: number,
        z: number,
        nthClosest: number,
        outPosition: MpVector3,
    ...
    calculateTravelDistanceBetweenPoints(x1: number, y1: number, z1: number, x2: number, y2: number, z2: number):
        number;
    getSafeCoordForPed(x: number, y: number, z: number, onGround: boolean, outPosition: MpVector3, flags: number):
        MpVector3;
    setRoadsInArea(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
    ...
    getNthClosestVehicleNode(x: number,
        y: number,
        z: number,
        nthClosest: number,
        outPosition: MpVector3,
    ...
    addNavmeshBlockingObject(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
        ...
        p7: boolean,
        p8: object): object;
    getClosestVehicleNodeWithHeading(x: number,
        y: number,
        z: number,
        outPosition: MpVector3,
        outHeading: number,
