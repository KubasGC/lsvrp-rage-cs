...
declare interface MpGameRope {
    ...
    attachEntitiesToRope(rope: MpObject | object,
        ent1: MpEntity | object,
        ent2: MpEntity | object,
        ent1_x: number,
        ent1_y: number,
        ent1_z: number,
        ent2_x: number,
        ...
        p12: object,
        p13: object): void;
    attachRopeToEntity(rope: MpObject | object,
        entity: MpEntity | object,
        x: number,
        y: number,
        z: number,
        p5: boolean | number): void;
    ...
    applyImpulseToCloth(posX: number,
        posY: number,
        posZ: number,
        vecX: number,
        vecY: number,
    ...
    addRope(x: number,
        ...
        unkPtr: object | number): MpObject | object;
