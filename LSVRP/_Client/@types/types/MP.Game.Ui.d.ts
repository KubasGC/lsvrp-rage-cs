...
declare interface MpGameUi {
    ...
    setNotificationMessage(picName1: string,
        picName2: string,
        flash: boolean,
        iconType: number,
        sender: string,
    ...
    setNotificationMessageClanTag2(picName1: string,
        picName2: string,
        flash: boolean,
        iconType1: number,
        sender: string,
    ...
    setNotificationMessageClanTag(picName1: string,
        picName2: string,
        flash: boolean,
        iconType: number,
        sender: string,
    ...
    setWarningMessage3(entryHeader: string,
        entryLine1: string,
        instructionalKey: object,
        entryLine2: string,
        p4: object,
        p5: object,
        p6: object,
    ...
    setWarningMessage(entryLine1: string,
    ...
    setWarningMessage2(entryHeader: string,
        entryLine1: string,
        instructionalKey: number,
        entryLine2: string,
        p4: boolean,
    ...
    releaseNamedRendertarget(p0: number): boolean;
