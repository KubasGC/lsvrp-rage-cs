...
declare interface MpGameVehicle {
    ...
    addVehicleStuckCheckWithWarp(p0: object,
        p1: number,
        p2: object,
        p3: boolean,
        p4: boolean,
    ...
    getRandomVehicleInSphere(x: number,
        y: number,
        z: number,
        radius: number,
        modelHash: number | string,
        flags: number): MpVehicle | object;
    ...
    removeVehiclesFromGeneratorsInArea(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
    ...
    setVehicleShootAtTarget(driver: MpPed | object,
    ...
    createScriptVehicleGenerator(x: number,
        y: number,
        z: number,
        heading: number,
        p4: number,
    ...
    createVehicle(modelHash: number | string,
        x: number,
        y: number,
        z: number,
        heading: number,
        networkHandle: boolean,
        vehiclehandle: boolean): object;
    ...
    getRandomVehicleBackBumperInSphere(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
        p5: number,
        p6: number): MpVehicle | object;
    ...
    setAllVehicleGeneratorsActiveInArea(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
        ...
        p6: boolean,
        p7: boolean): void;
    getRandomVehicleFrontBumperInSphere(p0: number,
        p1: number,
        p2: number,
        p3: number,
        p4: number,
    ...
    disableVehicleWeapon(disabled: boolean,
        weaponHash: number | string,
        vehicle: MpVehicle | object,
        owner: MpPed | object): void;
    doesScriptVehicleGeneratorExist(vehicleGenerator: number): boolean;
    getClosestVehicle(x: number, y: number, z: number, radius: number, modelHash: number | string, flags: number):
        MpVehicle | object;
