...
declare interface MpPlayer extends MpEntity {
    ...
    getAmmoInClip(weaponHash: any): number;
    ...
    setDefensiveAreaAttachedToPed(attachPed: MpPed | object,
        p2: number,
        p3: number,
        p4: number,
        p5: number,
    ...
    setHeadBlendData(shapeFirstID: number,
    ...
    getVehicleIsIn(getLastVehicle: boolean): MpVehicle;
    ...
    setIkTarget(p1: number,
        targetPed: MpPed | object,
        boneLookAt: number,
        x: number,
        y: number,
        z: number,
    ...
    setAngledDefensiveArea(p1: number,
        p2: number,
        p3: number,
        p4: number,
        p5: number,
    ...
    taskVehiclePark(vehicle: MpVehicle | object,
        x: number,
        y: number,
        z: number,
        heading: number,
    ...
    taskVehicleEscort(vehicle: MpVehicle | object,
        targetVehicle: MpVehicle | object,
        mode: number,
        speed: number,
        drivingStyle: number,
        minDistance: number,
        p7: number,
        noRoadsDistance: number): void;
    taskVehicleShootAt(target: MpPed | object, p2: number): void;
    taskGoToCoordWhileAimingAtCoord(x: number,
        y: number,
        z: number,
        aimAtX: number,
        aimAtY: number,
        ...
        flags: object,
        p13: boolean,
        firingPattern: number | string): void;
    ...
    taskVehicleDriveToCoordLongrange(vehicle: MpVehicle | object,
        x: number,
        y: number,
        z: number,
        speed: number,
    ...
    taskBoatMission(boat: MpVehicle | object,
        p2: object,
        p3: object,
        x: number,
        y: number,
        ...
        p10: number,
        p11: object): void;
    taskFollowNavMeshToCoord(x: number,
        y: number,
        z: number,
        speed: number,
        timeout: number,
    ...
    taskFollowNavMeshToCoordAdvanced(x: number,
        y: number,
        z: number,
        speed: number,
        timeout: number,
        ...
        unkZ: number,
        unk2: number): void;
    taskVehicleGotoNavmesh(vehicle: MpVehicle | object,
        x: number,
        y: number,
        z: number,
        speed: number,
    ...
    taskGoToCoordAnyMeansExtraParams(x: number,
        y: number,
        z: number,
        speed: number,
        p5: object,
    ...
    taskVehicleHeliProtect(vehicle: MpVehicle | object,
        entityToFollow: MpEntity | object,
        targetSpeed: number,
        p4: number,
        radius: number,
        altitude: number,
    ...
    taskDriveBy(targetPed: MpPed | object,
        p2: object,
        targetX: number,
        targetY: number,
        targetZ: number,
        ...
        p8: boolean,
        firingPattern: number | string): void;
    taskFollowToOffsetOf(entity: MpEntity | object,
        offsetX: number,
        offsetY: number,
        offsetZ: number,
        ...
        timeout: number,
        stoppingRange: number,
        persistFollowing: boolean): void;
    taskVehicleFollowWaypointRecording(vehicle: MpVehicle | object,
        WPRecording: string,
        p3: number,
        p4: number,
        p5: number,
    ...
    taskSeekCoverToCoords(x1: number,
        y1: number,
        z1: number,
        x2: number,
        y2: number,
    ...
    taskPutDirectlyIntoCover(x: number,
        y: number,
        z: number,
        timeout: object,
        p5: boolean,
    ...
    taskGoToCoordAnyMeans(x: number,
        y: number,
        z: number,
        speed: number,
        p5: object,
    ...
    taskPlayAnimAdvanced(animDict: string,
        animName: string,
        posX: number,
        posY: number,
        posZ: number,
    ...
    taskPlayPhoneGestureAnimation(p1: object,
        p2: object,
        p3: object,
        p4: number,
        p5: number,
    ...
    taskVehicleMissionTarget(vehicle: MpVehicle | object,
        pedTarget: MpPed | object,
        mode: number,
        maxSpeed: number,
        drivingStyle: number,
        minDistance: number,
    ...
    taskGoToWhileAimingAtEntity(entityToWalkTo: MpEntity | object,
        entityToAimAt: MpEntity | object,
        speed: number,
    ...
    taskGoToCoordAndAimAtHatedEntitiesNearCoord(gotoX: number,
        gotoY: number,
        gotoZ: number,
        aimNearX: number,
        aimNearY: number,
    ...
    taskGoToCoordAnyMeansExtraParamsWithCruiseSpeed(x: number,
        y: number,
        z: number,
        speed: number,
        p5: object,
    ...
    taskPlaneLand(plane: MpVehicle | object,
        runwayStartX: number,
        runwayStartY: number,
        runwayStartZ: number,
        runwayEndX: number,
    ...
    taskEnterVehicle(vehicle: MpVehicle | object,
        timeout: number,
        seat: number,
        speed: number,
        p5: number,
    ...
    taskGuardSphereDefensiveArea(p1: number,
        p2: number,
        p3: number,
        p4: number,
        p5: number,
    ...
    taskMoveNetworkAdvanced(p1: string,
        p2: number,
        p3: number,
        p4: number,
        p5: number,
        ...
        animDict: string,
        flags: number): void;
    taskGoStraightToCoord(x: number,
        y: number,
        z: number,
        speed: number,
        timeout: number,
    ...
    taskHeliMission(vehicle: MpVehicle | object,
        p2: object,
        pedToFollow: MpPed | object,
        posX: number,
        posY: number,
        posZ: number,
        mode: number,
    ...
    isWalking(): boolean;
    isInWrithe(): boolean;
    taskWanderInArea(x: number,
        y: number,
        z: number,
        radius: number,
        minimalLength: number,
        timeBetweenWalks: number): void;
    clearTasks(): void;
    taskVehicleDriveToCoord(vehicle: MpVehicle | object,
        x: number,
        y: number,
        z: number,
        speed: number,
    ...
    taskPlayAnim(animDictionary: string,
    ...
    taskSynchronizedScene(scene: number,
        ...
        playbackRate: number,
        p9: object): void;
    taskVehicleMissionCoorsTarget(vehicle: MpVehicle | object,
        x: number,
        y: number,
        z: number,
        p5: number,
    ...
    taskStartScenarioAtPosition(scenarioName: string,
        x: number,
        y: number,
        z: number,
        heading: number,
        ...
        p7: boolean,
        p8: boolean): void;
    taskVehicleFollow(vehicle: MpVehicle | object,
        targetEntity: MpEntity | object,
        drivingStyle: number,
        speed: number,
        minDistance: number): void;
}
