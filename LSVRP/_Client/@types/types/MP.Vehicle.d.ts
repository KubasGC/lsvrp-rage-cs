...
declare interface MpVehicle extends MpEntity {
    ...
    attachToTowTruck(vehicle: MpVehicle | object,
        rear: boolean,
        hookOffsetX: number,
        hookOffsetY: number,
        hookOffsetZ: number): void;
    ...
    setHandling(type: string, value: number);
    ...
    setExtra(extraId: number, toggle: boolean | number): void;
