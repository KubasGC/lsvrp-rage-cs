            ...
            r.isWindow = function(e) {
                ...
                r.each(e.nodeType ? [e] : e,
                    function(e, a) {
                        ...
                        ("fx" === t && n.unshift("inprogress"), o.call(a,
                            function() {
                                r.dequeue(a, t);
                            }));
                    });
                ...
                position: function() {
                    ...
                    return a.top -= parseFloat(t.style.marginTop) || 0, a.left -= parseFloat(t.style.marginLeft) || 0,
                        e.style &&
                        (n.top += parseFloat(e.style.borderTopWidth) || 0, n.left += parseFloat(
                                    ...
                                    for (var k in P) {
                                        if ("element" !== k) {
                                            ...
                                            if (1 === h) A = F.endValue;
                                                ...
                                                if (A =
                                                    F.startValue + E * j(h, u, E), !g && A === F.currentValue) continue;
                                            }
                ...
                Hooks: {
                    ...
                    cleanRootPropertyValue: function(e, t) {
                        return S.RegEx.valueUnwrap.test(t) && (t = t.match(S.RegEx.valueUnwrap)[1]),
                            S.Values.isCSSNullValue(t) && (t = S.Hooks.templates[e][1]), t;
                    },
                    ...
                    registered: {
                        ...
                        opacity: function(e, t, r) {
                            if (8 >= d)
                                ...
                                case "inject":
                                    return t.style.zoom = 1, parseFloat(r) >= 1
                                        ? ""
                    ...
                    function s(e, r) {
                        ...
                        if (8 >= d) l = f.css(e, r);
                            ...
                            g = i(e) === a
                                ...
                                "borderColor" === r && (r = "borderTopColor"), l =
            ...
            var P = function() {
                ...
                function n() {
                    function e(e) {
                        ...
                        function h() {
                            ...
                            if (n && a)
                                ...
                                var u = i(o).isSVG
                                    ...
                                    : r.createElement("div");
                                b.init(u), e.myParent.appendChild(u), f.each(["overflow", "overflowX", "overflowY"],
                                        function(e, t) {
                                            b.CSS.setPropertyValue(u, t, "hidden");
                                        }), b.CSS.setPropertyValue(u, "position", e.position),
                                    b.CSS.setPropertyValue(u, "fontSize", e.fontSize),
                                    b.CSS.setPropertyValue(u, "boxSizing", "content-box"), f.each(
                            ...
                            return null === L.remToPx &&
                                ...
                                l.remToPx = L.remToPx, l.vwToPx = L.vwToPx, l.vhToPx =
                                    L.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), o), l;
                        }
                        ...
                        if ("scroll" === A) {
                            ...
                            s.container
                                ...
                                : (P = b.State.scrollAnchor[b.State["scrollProperty" + F]], C =
                                        b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === F ? "Top" : "Left")]
                                        ],
                            ...
                            for (var z in y) {
                                ...
                                if (i(o).isSVG ||
                                    ...
                                    var W,
                                        ...
                                        Y,
                                        D = !1;
                                    if (W = d(z, M), M = W[0], Y = W[1], W = d(z, q), q = W[0].replace(/^([+-\/*])=/,
                                        function(e, t) {
                                            return D = t, "";
                                        }), G = W[1], M = parseFloat(M) || 0, q = parseFloat(q) || 0, "%" === G &&
                        ...
                        l.element &&
                        (S.Values.addClass(o, "velocity-animating"), R.push(l),
                            "" === s.queue && (i(o).tweensContainer = l, i(o).opts = s), i(o).isAnimating =
                                !0, V === w - 1
                    ...
                    b.mock !== !1 &&
                        ...
                        s.complete && !m.isFunction(s.complete) && (s.complete = null), s.display !== a &&
                            null !== s.display &&
                            (s.display = s.display.toString().toLowerCase(), "auto" === s.display &&
                                (s.display = b.CSS.Values.getDisplayType(o))), s.visibility !== a &&
                            null !== s.visibility &&
            ...
            ****************/
            ...
            if (methodName === 'destroy') {
                ...
                if ($curr_header.length &&
                    (methodName === 'open' || methodName === 'close' && $curr_header.hasClass('active'))) {
        ...
        this.each(function() {
            ...
            */
            function placeDropdown(eventType) {
                ...
                setTimeout(function() {
                        $(document).on('click.' + activates.attr('id'),
                            function(e) {
                                hideDropdown();
            ...
            if (curr_options.hover) {
                ...
                origin.off('click.' + origin.attr('id'));
                origin.on('click.' + origin.attr('id'),
                    function(e) {
                        if (!isFocused) {
            ...
            origin.on({
                'mouseenter.tooltip': function(e) {
                    var showTooltip = function() {
                        ...
                        tooltipEl
                            .velocity({ translateY: tooltipVerticalMovement, translateX: tooltipHorizontalMovement },
        ...
        $.fn.autocomplete = function(options) {
            ...
            return this.each(function() {
                ...
                if (!$.isEmptyObject(data)) {
                    ...
                    // Set input value
                    $autocomplete.off('mousedown.autocomplete touchstart.autocomplete').on(
...
(function($) {
    ...
    $.fn.material_chip = function(options) {
        ...
        this.setPlaceholder = function($chips) {
            ...
            } else if (($chips.data('chips') === undefined || !!$chips.data('chips').length) &&
...
(function($) {
    ...
    var openFABMenu = function(btn) {
        ...
        if ($this.hasClass('active') === false) {
            ...
            $this.addClass('active');
            $this.find('ul .btn-floating')
                .velocity({ scaleY: ".4", scaleX: ".4", translateY: offsetY + 'px', translateX: offsetX + 'px' },
                    { duration: 0 });

            var time = 0;
            $this.find('ul .btn-floating').reverse().each(function() {
                $(this).velocity({ opacity: "1", scaleX: "1", scaleY: "1", translateY: "0", translateX: '0' },
                ...
                get: function(thing, format) {
                    ...
                    if (thing in P.component.item) {
                        if (typeof format == 'string') {
                            ...
                            return thingValue
                                ? PickerConstructor._.trigger(P.component.formats.toString,
                                    P.component,
                                    [format, thingValue])
                                : '';
                        }
    ...
    PickerConstructor._ = {
        ...
        group: function(groupObject) {
            ...
            for (;
                ...
                nodesList += PickerConstructor._.node(groupObject.node,
...
(function(factory) {
    ...
    DatePicker.prototype.set = function(type, value, options) {
        ...
        calendarItem[type == 'enable' ? 'disable' : type == 'flip' ? 'enable' : type] = calendar.queue[type].split(' ')
            .map(function(method) {
                ...
                while (/*safety &&*/calendar.disabled(dateObject)) {
                    ...
                    if (dateObject.pick <= minLimitObject.pick) {
                        ...
                        dateObject = calendar.create([
                            minLimitObject.year, minLimitObject.month,
                        ...
                        interval = -1;
                        dateObject = calendar.create([
                            maxLimitObject.year, maxLimitObject.month,
    ...
    DatePicker.prototype.nodes = function(isOpen) {
                    ...
                    _.node('tr',
                        _.group({
                            ...
                            item: function(counter) {
                                return [
                                    collection[counter], settings.klass.weekdays,
        ...
        return _.node(
            ...
            _.node('div',
                                    ...
                                    return [
                                        _.group({
                                            ...
                                            item: function(targetDate) {
                                                ...
                                                var isSelected =
                                                        selectedObject && selectedObject.pick == targetDate.pick,
                                                    isHighlighted = highlightedObject &&
                                                        highlightedObject.pick == targetDate.pick,
                                                    isDisabled = disabledCollection && calendar.disabled(targetDate) ||
                                                        targetDate.pick < minLimitObject.pick ||
                                                        targetDate.pick > maxLimitObject.pick,
                                                    formattedDate = _.trigger(calendar.formats.toString,
                                                        calendar,
                ...
                'picker__container__wrapper'); //endreturn
...
(function() {
    ...
    var svgNS = 'http://www.w3.org/2000/svg',
        svgSupported = 'SVGAngle' in window &&
            function() {
                var supported,
    ...
    // Popover template
    var tpl = [
        '<div class="clockpicker picker">', '<div class="picker__holder">', '<div class="picker__frame">',
        '<div class="picker__wrap">', '<div class="picker__box">', '<div class="picker__date-display">',
        '<div class="clockpicker-display">', '<div class="clockpicker-display-column">',
        '<span class="clockpicker-span-hours text-primary"></span>', ':',
        '<span class="clockpicker-span-minutes"></span>', '</div>',
        '<div class="clockpicker-display-column clockpicker-display-am-pm">',
        '<div class="clockpicker-span-am-pm"></div>', '</div>', '</div>', '</div>',
        '<div class="picker__container__wrapper">', '<div class="picker__calendar-container">',
        '<div class="clockpicker-plate">', '<div class="clockpicker-canvas"></div>',
        '<div class="clockpicker-dial clockpicker-hours"></div>',
        '<div class="clockpicker-dial clockpicker-minutes clockpicker-dial-out"></div>', '</div>',
        '<div class="clockpicker-am-pm-block">', '</div>', '</div>', '<div class="picker__footer">', '</div>', '</div>',
        '</div>', '</div>', '</div>', '</div>', '</div>'
    ].join('');
    ...
    function ClockPicker(element, options) {
        ...
        if (options.twelvehour) {
            if (!options.ampmclickable) {
                ...
                this.spanAmPm.empty();
                $('<div id="click-am">AM</div>').on("click",
                    function() {
                        self.spanAmPm.children('#click-am').addClass("text-primary");
                        self.spanAmPm.children('#click-pm').removeClass("text-primary");
                        self.amOrPm = "AM";
                    }).appendTo(this.spanAmPm);
                $('<div id="click-pm">PM</div>').on("click",
                    function() {
        ...
        $('<button type="button" class="btn-flat picker__clear" tabindex="' +
            ...
            '">' +
            options.cleartext +
            '</button>').click($.proxy(this.clear, this)).appendTo(this.footer);
        $('<button type="button" class="btn-flat picker__close" tabindex="' +
            (options.twelvehour ? '3' : '1') +
            '">' +
            options.canceltext +
            '</button>').click($.proxy(this.hide, this)).appendTo(this.footer);
        $('<button type="button" class="btn-flat picker__close" tabindex="' +
            (options.twelvehour ? '3' : '1') +
            '">' +
            options.donetext +
        ...
        function mousedown(e, space) {
            ...
            $doc.off(mousemoveEvent).on(mousemoveEvent,
                function(e) {
                    e.preventDefault();
            ...
            // Mouseup on document
            $doc.off(mouseupEvent).on(mouseupEvent,
                function(e) {
    ...
    ClockPicker.prototype.show = function(e) {
        ...
        if (!this.isAppended) {
            ...
            $win.on('resize.clockpicker' + this.id,
                function() {
                    if (self.isShown) {
                        self.locate();
                    }
        ...
        $doc.on('click.clockpicker.' + this.id + ' focusin.clockpicker.' + this.id,
            function(e) {
                var target = $(e.target);
                if (target.closest(self.popover.find('.picker__wrap')).length === 0 &&
                    target.closest(self.input).length === 0) {
                    self.hide();
                }
            });
        // Hide when ESC is pressed
        $doc.on('keyup.clockpicker.' + this.id,
            function(e) {
                if (e.keyCode === 27) {
                    self.hide();
                }
...
(function($) {
    ...
    function addCounterElement($input) {
        ...
        $counterElement = $('<span/>').addClass('character-counter').css('float', 'right').css('font-size', '12px')
            .css('height', 1);
        ...
        init: function(options) {
            ...
            return this.each(function(i) {
                ...
                var setCarouselHeight = function(imageOnly) {
                    var firstSlide = view.find('.carousel-item.active').length
                        ? view.find('.carousel-item.active').first()
                        : view.find('.carousel-item').first();
