...
})(typeof global !== 'undefined' ? global : window || this.window || this.global,
    function(root) {
        ...
        var defaults = {
            ...
            transitionIn:
                'fadeInUp', // bounceInLeft, bounceInRight, bounceInUp, bounceInDown, fadeIn, fadeInDown, fadeInUp, fadeInLeft, fadeInRight, flipInX
                    ...
                    if (xpos !== 0) {
                        ...
                        if (xpos > 0) {
                            ...
                            if (opacity < opacityRange) {
                                instance.hide(toast,
                                    extend(settings,
                                        { transitionOut: 'fadeOutRight', transitionOutMobile: 'fadeOutRight' }),
                                    'drag');
                            }
                        } else {
                            opacity = (distance + xpos) / distance;
                            if (opacity < opacityRange) {
                                instance.hide(toast,
                                    extend(settings,
                                        { transitionOut: 'fadeOutLeft', transitionOutMobile: 'fadeOutLeft' }),
                                    'drag');
                            }
                        }
        ...
        $iziToast.destroy = function() {
            ...
            forEach(document.querySelectorAll('.' + PLUGIN_NAME + '-wrapper'),
                ...
                resume: function() {
                    ...
                    if ($elem !== null) {
                        $elem.style.transition =
                            'width ' + settings.TIME.REMAINING + 'ms ' + settings.progressBarEasing;
                        $elem.style.width = '0%';
                    }
        ...
        $iziToast.hide = function($toast, options, closedBy) {
            ...
            try {
                ...
                var event = new CustomEvent(PLUGIN_NAME + '-closing',
                    { detail: settings, bubbles: true, cancelable: true });
        ...
        $iziToast.show = function(options) {
            ...
            let audioSound = new Audio("dist/sounds/definite.ogg");
            ...
            if (settings.toastOnce &&
                settings.id &&
                document.querySelectorAll('.' + PLUGIN_NAME + '#' + settings.id).length > 0) {
                return false;
            }
                ...
                if (settings.image) {
                    ...
                    if (isBase64(settings.image.replace(/ /g, ''))) {
                        $DOM.cover.style.backgroundImage =
                            'url(data:image/png;base64,' + settings.image.replace(/ /g, '') + ')';
                    } else {
            ...
            (function() {
                if (settings.close) {
                    ...
                    $DOM.buttonClose.addEventListener('click',
                        function(e) {
                            var button = e.target;
            ...
            (function() {
                if (settings.timeout) {
                    ...
                    if (settings.pauseOnHover && !settings.resetOnHover) {
                        ...
                        $DOM.toast.addEventListener('mouseenter',
                            function(e) {
            ...
            (function() {
                ...
                if (settings.overlay) {
                    ...
                    if (document.querySelector('.' + PLUGIN_NAME + '-overlay.fadeIn') !== null) {
                        ...
                        $DOM.overlay.setAttribute('data-iziToast-ref',
                            $DOM.overlay.getAttribute('data-iziToast-ref') + ',' + settings.REF);
            ...
            (function() {
                if (settings.animateInside) {
                    ...
                    if (settings.buttons.length > 0 && $DOM.buttons) {
                        var counter = 150;
                        forEach($DOM.buttons.childNodes,
                            function(element, index) {
            ...
            if (settings.drag) {
                ...
                if (ACCEPTSTOUCH) {
                    ...
                    $DOM.toast.addEventListener('touchstart',
                        function(e) {
                            drag.startMoving(this, that, settings, e);
                        },
                        false);

                    $DOM.toast.addEventListener('touchend',
                        function(e) {
                    ...
                    $DOM.toast.addEventListener('mousedown',
                        function(e) {
                            e.preventDefault();
                            drag.startMoving(this, that, settings, e);
                        },
                    ...
                    $DOM.toast.addEventListener('mouseup',
                        function(e) {
                            e.preventDefault();
                            drag.stopMoving(this, e);
                        },
